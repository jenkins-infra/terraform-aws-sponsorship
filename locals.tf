locals {
  ...
  cijenkinsio_agents_2_cluster_addons_coredns_addon_version             = "v1.13.2-eksbuild.7"
  cijenkinsio_agents_2_cluster_addons_kubeProxy_addon_version           = "v1.33.10-eksbuild.5"
  cijenkinsio_agents_2_cluster_addons_vpcCni_addon_version              = "v1.21.1-eksbuild.8"
  cijenkinsio_agents_2_cluster_addons_awsEbsCsiDriver_addon_version     = "v1.59.0-eksbuild.1"
  ...
  cijenkinsio_agents_2_ami_release_version = "1.33.11-20260423"
