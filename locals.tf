locals {
  ...
  cijenkinsio_agents_2_cluster_addons_awsEbsCsiDriver_addon_version     = "v1.51.1-eksbuild.1"
  cijenkinsio_agents_2_cluster_addons_awsS3CsiDriver_addon_version      = "v2.1.0-eksbuild.1"
  cijenkinsio_agents_2_cluster_addons_eksPodIdentityAgent_addon_version = "v1.3.8-eksbuild.2"

  cijenkinsio_agents_2_ami_release_version = "1.32.9-20251016"
